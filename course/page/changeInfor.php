...
if (isset($_POST['register_button'])) {
   ...
   $_SESSION['message'] = "must be a list of numbers and greater than 10 and less than 12";
			...
			header("location: index.php?page=changeInfor"); //
 ...
 <?php 
	...
	<form method="POST" action="index.php?page=changeInfor"  class="beta-form-checkout">
		<table>
			...
			<tr>
				<td>Full name: </td>
				<td><input type="text" name="fullname"  class="form-control" value="<?= $student['full_name']; ?>" disabled></td>
			</tr>
		</div>
