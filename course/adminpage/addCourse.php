...
if (isset($_POST['register_button'])) {
	...
	if (mysqli_num_rows($result1) >= 1) {
       ...
       $_SESSION['message'] = "invalid name";
           ...
           $_SESSION['message'] = "location has to be equal to 4 characters";
             }
 ...
 <?php 
	...
	<form method="POST" action="admin.php?adminpage=addCourse&IDsubject=<?= $IDsubject;?>" class="beta-form-checkout">
		...
		<div class="form-group">
			<tr>
				<td>start date: </td>
				<td><input type="date" name="start_date" class="form-control" required>
				</td>
			</tr>
		</div>
...
<input type="text"  name="schedule" class="form-control" required>
		 ...
		 <div class="form-group">
			<tr>
				<td>max students: </td>
				<td><input type="number" max="100" min="2" name="max_student" class="form-control" required></td>
			</tr>
		</div>
...
<div class="form-group">
			<tr>
				...
				<td><input type="date" name="end_registration" class="form-control" min="<?=$nowdate;?>" required>
				</td>
			</tr>
		</div>
