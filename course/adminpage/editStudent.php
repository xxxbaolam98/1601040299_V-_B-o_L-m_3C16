 ...
 $student_ID = $_GET['ID'];
   ...
   $_SESSION['message'] = "must be a list of numbers and greater than 10 and less than 12";
       ...
       $_SESSION['message'] = "the year must be greater than 2017";            	
			...
			$sql = "UPDATE student SET student_id='$student_id', full_name = '$fullname', email = '$email', address = '$address', phone = '$phone', date_birth = '$datebirth', year_begin = '$freshmen_year', gender = '$gender', student_condition = '$condition' WHERE id=".$_GET['ID'];
...
<div class="form-group">
		...
		<div class="form-group">
			<tr>
				<td>date of birth: </td>
				<td><input type="date" name="datebirth" max="2001-01-01" class="form-control" value="<?= $student['date_birth']; ?>" required>
				 </td>
			</tr>
		</div>
